...
You are required to implement a type-level parser to parse *JSON String* into a object literal type.

## Details
If you are still confused about implement details, please go to read [Introducing JSON](https://www.json.org/).

## Notes 
Due to the complexity of *Numbers* and *Unicode Escape* features in JSON, there is no need to implement their parsing in your solution.
