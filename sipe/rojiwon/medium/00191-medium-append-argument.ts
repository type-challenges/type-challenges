...
type Append<T extends any[], U> = T extends [infer Head, ...infer Rest] ? [Head, ...Rest, U] : [U]

type AppendArgument<Fn extends (...args: any[]) => any, A> = (...args: Append<Parameters<Fn>, A>) => ReturnType<Fn>
