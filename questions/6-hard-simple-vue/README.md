...
- `data` is a simple function that returns a object that expose the the context `this`, but you can't access data itself or other computed values or methods in `data`.
